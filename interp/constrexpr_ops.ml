...
let qualuniv_expr_eq (q1, u1 : qualuniv_expr) (q2, u2) =
  q1 = q2 && u1 = u2

let opt_qualuniv_expr_eq qu1 qu2 =
  Option.equal qualuniv_expr_eq qu1 qu2
  ...
  let constr_expr_eq e1 e2 =
    if CAst.(e1.v == e2.v) then true
      ...
      | CCases(_,r1,a1,brl1), CCases(_,r2,a2,brl2) ->
        ...
        Option.equal (fun (r1, qu1) (r2, qu2) -> constr_expr_eq r1 r2 && opt_qualuniv_expr_eq qu1 qu2) r1 r2 &&
      ...
      | CLetTuple (n1, (m1, e1), t1, b1), CLetTuple (n2, (m2, e2), t2, b2) ->
        ...
        Option.equal (fun (r1, qu1) (r2, qu2) -> constr_expr_eq r1 r2 && opt_qualuniv_expr_eq qu1 qu2) e1 e2 &&
