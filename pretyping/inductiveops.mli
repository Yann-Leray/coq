...
val make_case_or_project :
  ...
  (* pred *) EConstr.constr * EConstr.ESorts.t -> (* term *) EConstr.constr -> (* branches *) EConstr.constr array -> EConstr.constr
...
val simple_make_case_or_project :
  ...
  (* pred *) EConstr.constr * EConstr.ESorts.t -> EConstr.case_invert -> (* term *) EConstr.constr -> (* branches *) EConstr.constr array -> EConstr.constr
