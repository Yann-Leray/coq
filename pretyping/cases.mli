...
val compile_cases :
  ...
  type_constraint ->
  GlobEnv.t -> (glob_constr * ESorts.t option) option * tomatch_tuples * cases_clauses ->
...
val prepare_predicate : ?loc:Loc.t -> program_mode:bool ->
           ...
           rel_context list ->
           constr option ->
           (glob_constr * ESorts.t option) option -> (Evd.evar_map * (Name.t * Name.t list) list * constr * ESorts.t option) list
