...
val pattern_match : (Quality.t -> Quality.t -> bool) * (Univ.Level.t -> Univ.Level.t -> bool) -> pattern -> t -> ('t, Quality.t, Univ.Level.t) Partial_subst.t -> ('t, Quality.t, Univ.Level.t) Partial_subst.t option
