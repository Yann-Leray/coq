...
sig
  ...
  val pattern_match : (Quality.t -> Quality.t -> bool) * (Universe.t -> Universe.t -> bool) -> mask -> t -> ('term, Quality.t, Universe.t) Partial_subst.t -> ('term, Quality.t, Universe.t) Partial_subst.t option
end
